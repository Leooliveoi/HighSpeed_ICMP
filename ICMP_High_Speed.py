...
'''
LIB ipaddress:
	Usado para manipular ips de forma mais simples e facil
	ipaddress.ip_address("ip") -> Cria objeto IP

	ipaddress.ip_network("ip/24 ou /16 ou /8...", strict=False) -> Cria um objeto do tipo rede para manipular blocos de IP
...
def listen(responses, ip_network):
    try:
        ...
        print("PERMISSION DENIED, ARE YOU A ROOT?")
    except Exception as e:
        print("Error ...", e)
...
if __name__ == "__main__":
    try:
        responses = [] 
        print("Need a Root Privileges\nUse Python 3.x\n")
        ips = "127.0.0.0/24"  # Internet network
